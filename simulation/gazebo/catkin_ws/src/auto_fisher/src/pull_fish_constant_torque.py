...
class FishPull():
    def __init__(self):
        ...
        # self.pub = rospy.Publisher('fisher_robot/joint1_position_controller/state/', std_msgs.msg.Float64, queue_size=10)
    ...
    def pull_fish(self):
        # self.pub.publish(std_msgs.msg.Float64(-500))
...
if __name__ =="__main__":
    ...
    rospy.init_node('pull_fish_const_torque')
